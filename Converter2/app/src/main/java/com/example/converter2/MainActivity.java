...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSubmit.setText("Convert");
        first = (EditText) findViewById(R.id.InputEditText);
        second = (TextView) findViewById(R.id.OutputTextView);
    ...
    public void onClick(View v) {
        ...
        float value = Float.parseFloat(first.getText().toString());
